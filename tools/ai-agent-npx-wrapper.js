...
if (isNpxExecution) {
  ...
  const installerPath = path.join(__dirname, 'installer', 'bin', 'ai-agent.js');

  if (!fs.existsSync(installerPath)) {
    console.error('Error: Could not find ai-agent.js at', installerPath);
  ...
  require('./installer/bin/ai-agent.js');
}
